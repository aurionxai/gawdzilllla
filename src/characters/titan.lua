...
local STATS = {
  ...
  maxHealth     = 80,
  moveSpeed     = 110,
  color         = { 0.08, 0.20, 0.72 },
}

local ATTACKS = {
  light   = { damage=12, powerGain=5,  powerCost=0,  stunDuration=0,
              hitboxW=24, hitboxH=22, hitboxOffX=20, startupTime=0.1, activeTime=0.15, recoveryTime=0.2 },
  heavy   = { damage=30, powerGain=15, powerCost=0,  stunDuration=0.5,
              hitboxW=32, hitboxH=28, hitboxOffX=26, startupTime=0.25,activeTime=0.2,  recoveryTime=0.4 },
  special = { damage=20, powerGain=0,  powerCost=25, stunDuration=0.2,
              hitboxW=85, hitboxH=12, hitboxOffX=45, startupTime=0.3, activeTime=0.5,  recoveryTime=0.3 },
