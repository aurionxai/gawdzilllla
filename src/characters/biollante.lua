...
local ATTACKS = {
  ...
  special = { damage=20, powerGain=0,  powerCost=25, stunDuration=0.2,
              hitboxW=120, hitboxH=8, hitboxOffX=45, startupTime=0.3, activeTime=0.5,  recoveryTime=0.3 },
