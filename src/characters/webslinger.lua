...
local ATTACKS = {
  light   = { damage=12, powerGain=5,  powerCost=0,  stunDuration=0,
              hitboxW=30, hitboxH=22, hitboxOffX=20, startupTime=0.06, activeTime=0.10, recoveryTime=0.2 },
