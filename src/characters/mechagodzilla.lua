-- src/characters/mechagodzilla.lua
local Character = require("src/character")
local AS        = require("src/attack_system")
local SL        = require("src/sprite_loader")

local STATS = {
  characterName = "MechaGodzilla",
  maxHealth     = 140,
  moveSpeed     = 60,
  color         = { 0.63, 0.65, 0.70 },
}
